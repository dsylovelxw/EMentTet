...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {background:url(/EMentTet/images/icon-login.png) no-repeat 1px 0;}
        .login-main .login-bottom .center .item .icon-2 {background:url(/EMentTet/images/icon-login.png) no-repeat -54px 0;}
        .login-main .login-bottom .center .item .icon-3 {background:url(/EMentTet/images/icon-login.png) no-repeat -106px 0;}
        .login-main .login-bottom .center .item .icon-4 {background:url(/EMentTet/images/icon-login.png) no-repeat 0 -43px;position:absolute;right:-10px;cursor:pointer;}
        .login-main .login-bottom .center .item .icon-5 {background:url(/EMentTet/images/icon-login.png) no-repeat -55px -43px;}
        .login-main .login-bottom .center .item .icon-6 {background:url(/EMentTet/images/icon-login.png) no-repeat 0 -93px;position:absolute;right:-10px;margin-top:8px;cursor:pointer;}
        ...
        body {background:url(/EMentTet/images/loginbg.png) 0% 0% / cover no-repeat;position:static;font-size:12px;}
    ...
    <div class="login-main">
        ...
        <form class="layui-form login-bottom">
            ...
            <div class="tip">
                ...
                <a href="http://localhost:8080/EMentTet/jsp/zc/zc.jsp" class="forget-password">注册账号</a>
            </div>
...
<script>
    layui.use(['form','jquery'], function () {
        ...
        form.on('submit(login)', function (data) {
            ...
            $.ajax({
            	url:"/EMentTet/DengLuServlet?action=DengluYan",
            	type:"post",
            	data:{
            		"name":data.username,
            		"pwd":data.password
           		...
           		success:function(data){
           			if(1 == data.status){
           				...
           				setTimeout(function(){
	        	            ...
	        	            window.location = '/EMentTet/quan.jsp';
        	        	},1000);
           			}else{
           				layer.msg(data.message);
           			}
